...
#define DEBUG_L1        0x800   // DBTEXT:  Debug at level 1
#define DEBUG_MSRC      0x1000  // DBTEXT:  Debug MSRC operation
#define DEBUG_CONNCACHE 0x2000  // DBTEXT:  Debug connection cache
#define DEBUG_SERVE_GTC 0x4000  // DBTEXT:  Debug server side GTC
#define DEBUG_SERVE_NOOP 0x8000  // DBTEXT:  Debug server side NOOP
#define DEBUG_CE        0x10000  // DBTEXT:  Debug CE
